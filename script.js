...
setInterval(() => {
    ...
    my_age = Math.round(my_age * 1000000000000) / 1000000000000
    my_age = my_age.toFixed(12)
...
function underline_menu(you_are_in){
    ...
    else if(you_are_in == "about"){underlined = "about_id"} //, age()
...
kontakt_el.addEventListener('mouseover', function handleMouseOver() {
    menu_off()
    kontakt_el.style.textDecoration = "underline";
    kontakt_el.style.color = "#3185FC"
});
kontakt_el.addEventListener('mouseout', function handleMouseOut() {
    kontakt_el.style.textDecoration = "none";
    kontakt_el.style.color = "#BCC8C6"
    menu_on()
});

//Jazyk
const language_el = document.getElementById('language-button');
language_el.addEventListener('mouseover', function handleMouseOver() {
    language_el.style.textDecoration = "underline";
    language_el.style.color = "#3185FC"
});
language_el.addEventListener('mouseout', function handleMouseOut() {
    language_el.style.textDecoration = "none";
    language_el.style.color = "#BCC8C6"
});
